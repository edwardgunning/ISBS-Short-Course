...
In the `fda` package, we combine these two component parts to produce a `fd` ("functional data") object. If we know the basis function system and the matrix of basis coefficients, the code to set up the `fd` object is very simple.
